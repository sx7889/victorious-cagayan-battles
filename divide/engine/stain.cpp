...
stainrenderer stains[] =
{
    ...
    stainrenderer("<grey>media/particle/spark.png", SF_ROTATE, 500),
    stainrenderer("<grey>media/particle/spark.png", SF_ROTATE|SF_OVERBRIGHT),
    stainrenderer("<grey>media/particle/spark.png", SF_ROTATE|SF_GLOW|SF_SATURATE, 250, 1500, 250),
    stainrenderer("<grey>media/particle/spark.png",  SF_ROTATE|SF_GLOW|SF_SATURATE, 100, 1100, 100)
};
