...
extern void renderbackground(const char *caption = NULL, const char *info = NULL, bool force = false);
...
extern int mainmenu;
extern char backgroundimage[256];
