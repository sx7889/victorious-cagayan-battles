...
namespace entities
{
    ...
    extern void setup(extentity &e);
    extern void fix(extentity &e);
...
namespace game
{
    extern bool clientoption( const char* );
    ...
    extern const char *editorconfig();
    ...
    extern void mainmenuhud(int w, int h);
    extern bool canjump();
    extern bool cancrouch();
    extern bool allowmove(physent *d);
    extern void preparetomove( physent* );
    extern dynent *iterdynents(int i);
    extern int numdynents();
    extern void rendergame();
    extern void renderavatar();
    extern void preframe();
    extern void renderplayerpreview( int );
    extern int numanims();
    ...
    extern void soundconfig();
}

namespace server
{
    extern bool serveroption( const char* );
