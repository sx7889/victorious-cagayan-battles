...
- (void)findPaths
{
    ...
    // userpath: directory where user files are kept - typically /Users/<name>/Application Support/victorious
    path = nil;
...
// plist registers 'victorious' as a url scheme
